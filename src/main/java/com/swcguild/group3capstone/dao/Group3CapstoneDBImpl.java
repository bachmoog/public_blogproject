 ...
 * @author Jim
 */
public class Group3CapstoneDBImpl implements Group3CapstoneInterface {
    ...
    private static final String SQL_INSERT_STATIC_PAGE
            = "INSERT INTO static_pages (page_content, user_id, date_created) VALUES (?,?,?)";
    ...
    private static final String SQL_UPDATE_STATIC_PAGE
            = "UPDATE static_pages SET (page_content=?, user_id=?, date_created=?) WHERE static_page_id = ?";
...
//          BLOGS
    private static final String SQL_INSERT_BLOG
            = "INSERT INTO blogs (blog_title, blog_date, blog_content, user_id, published, approved) VALUES (?,?,?,?,?,?)";

    private static final String SQL_DELETE_BLOG
            = "DELETE FROM blogs WHERE blog_id=?";

    private static final String SQL_UPDATE_BLOG
            = "UPDATE blogs SET blog_title = ?, blog_date = ?, blog_content = ?, "
            + "user_id = ?, published = ?, approved = ? WHERE blog_id = ?";
...
// @@@@@@@@@@@@@@@@@   USERS  @@@@@@@@@@@@@@@@@@@@@@@@@    
    ...
    public void addCategory(Category category, int blogId) {
        ...
        category.setCategoryId(jdbcTemplate.queryForObject("SELECT LAST_INSERT_ID() FROM categories", Integer.class));
    ...
    public void addHashtag(Hashtag hashtag, int blogId) {
        jdbcTemplate.update(SQL_INSERT_HASHTAG,
                hashtag.getHashtag());
        hashtag.setHashtagId(jdbcTemplate.queryForObject("SELECT LAST_INSERT_ID() FROM hashtags", Integer.class));
...
//        jdbcTemplate.update(SQL_INSERT_BLOG_HASHTAG, hashtag.getHashtagId()); // 
    ...
    public void addStaticPage(StaticPage staticPage) {
        ...
        staticPage.setStaticPageId(jdbcTemplate.queryForObject("SELECT LAST_INSERT_ID() FROM static_pages", Integer.class));
    }
...
// @@@@@@@@@@@@@@@@@@@  BLOGS @@@@@@@@@@@@@@@@@@@@@@@@
    ...
    public List<Blog> getBlogsByCategoryId(int categoryId) {
        ...
        try {
            blogCatList = jdbcTemplate.query(SQL_GET_BLOGS_BY_CATEGORY_ID, new BlogMapper());
        } catch (EmptyResultDataAccessException e) {
            return null;
        }
